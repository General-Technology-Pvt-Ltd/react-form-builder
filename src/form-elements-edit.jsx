...
export default class FormElementsEdit extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      dirty: false,
      tags: this.props.element.validationRule
  ...
  render() {
    ...
    const this_conditonal_rule = this.props.element.hasOwnProperty(
      ...
      : "";
    const populateKey = this.props.element.hasOwnProperty("populateKey")
    ...
    const this_validation_rule = this.props.element.hasOwnProperty(
      ...
      ? this.props.element.validationRule
      : [];
    const this_bootstrap_rule = this.props.element.hasOwnProperty(
      "bootstrapRule"
    )
      ? this.props.element.bootstrapRule
      : [];
    const {
    ...
    function getConditionalVisibilityEditor() {
      return (
        <>
          {
            <div className="form-group">
              <label className="" htmlFor="is-conditional-rule">
    ...
    function getBootstrapStyleEditor() {
      return (
        <BootstrapStyle
          data={this.props.preview.state.data}
          updateElement={this.props.updateElement}
    ...
    return (
      <div>
        ...
        {this.props.element.hasOwnProperty("content") &&
          getContentEditor.call(this)}

        {this.props.element.hasOwnProperty("file_path") &&
          getFilePathEditor.call(this)}

        {this.props.element.hasOwnProperty("href") && getHrefEditor.call(this)}

        {this.props.element.hasOwnProperty("src") &&
          getImageSrcEditor.call(this)}

        {this.props.element.hasOwnProperty("label") &&
          getLabelEditor.call(this)}

        {/* {this.props.element.element === "bootstrapRule" &&
          getBootstrapStyleEditor.call(this)} */}
        {getBootstrapStyleEditor && getBootstrapStyleEditor.call(this)}
        {this.props.element.element === "AutoPopulate" &&
          getAutoPopulateEditor.call(this)}

        {this.props.element.hasOwnProperty("label") &&
          canEditFieldName &&
          canEditFieldName === true &&
          getFieldNameEditor.call(this)}
        ...
        {this.props.showCorrectColumn &&
          ...
          getCorrectAnswerEditor.call(this)}

        {this.props.element.canPopulateFromApi &&
          this.props.element.hasOwnProperty("options") &&
          getPopulateApiEditor.call(this)}

        {this.props.element.hasOwnProperty("options") &&
          getDynamicOptionList.call(this)}
        {this.props.element.canHaveValidation && getValidationEditor.call(this)}
        {this.props.element.hasOwnProperty("prefix") &&
