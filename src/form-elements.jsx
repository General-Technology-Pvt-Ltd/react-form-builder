...
class Checkboxes extends React.Component {
  ...
  handleChange = (event) => {
    // console.log('value', this.props.data.options)
    // console.log(this.props.data.conditonalRule)
    if (this.props.data.conditonalRule == "yes") {
      this.setState({ form: <input type="text" placeholder="Why Yes" /> });
    } else if (this.props.data.conditonalRule == "no") {
      this.setState({ form: <input type="text" placeholder="Why No" /> });
    }
  };
