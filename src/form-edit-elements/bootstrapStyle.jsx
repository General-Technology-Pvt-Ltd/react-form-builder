...
//       dirty: false,
//       availableRules: this.props.element.availableValidationRules
//         ? this.props.element.availableValidationRules
//         : [],
//     };
//   }
...
//   getRule(index) {
//     const { element } = this.state;
//     return this.state.availableRules.filter(
//       (x) => x.key === element.validationRules[index].rule
//     );
//   }
...
//   ruleIsAvailable(r) {
//     if (r.hasOwnProperty("onlyOn")) {
//       if (Array.isArray(r.onlyOn)) {
//         return r.onlyOn.includes(this.state.element.element);
//       }
//       return r.onlyOn === this.state.element.element;
//     }
//     return true;
//   }
...
//                           if (
//                             this.ruleIsCurrentlySelected(r.key, index) ||
//                             this.ruleIsNotSelected(r.key)
//                           ) {
//                             return (
//                               <option value={r.key}>
//                                 {r.title
//                                   ? r.title
//                                   : r.key.charAt(0).toUpperCase() +
//                                     r.key.slice(1)}
//                               </option>
//                             );
//                           }
...
//                       <button
//                         onClick={this.addRule.bind(this, index)}
